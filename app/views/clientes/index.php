				...
				<div class="base-lista">
					<div>
						<div class="text-end d-flex">
							<a href="<?php echo URL_BASE."clientes/create" ?>" class="btn btn-verde d-inline-block mb-2 mx-1"><i class="fas fa fa-plus-circle" aria-hidden="true"></i> Cadastrar cliente</a>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="dataTable">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo $clientes->dtnasc; ?></td>
								<td><?php echo $clientes->endereco; ?></td>
								<td><?php echo $clientes->tel; ?></td>
								<td><?php echo $clientes->cep; ?></td>
								<td align="center">
									<a href="<?php echo URL_BASE."contato/edit/".$clientes->idcliente ?>" class="btn btn-editar" title="Editar"></a>
									<a href="<?php echo URL_BASE."contato/excluir/".$clientes->idcliente ?>" class="btn btn-exlcuir" title="excluir"></a>
								</td>
							</tr>
							<?php } ?>	
